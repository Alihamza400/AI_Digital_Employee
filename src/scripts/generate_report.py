...
def generate_report():
    ...
    pdf.add_table(
        ...
        [
            ...
            ["http.server (stdlib)", "Approval UI server", "Zero-dependency, token-authenticated"],
            ...
            ["pytest", "Test suite", "Unit, integration & end-to-end coverage"],
            ["Ruff / Black", "Linting & formatting", "Enforced in CI on every push"],
        ],
        [40, 38, 70],
    )
    ...
    pdf.add_table(
        ...
        [
            ...
            ["Authenticated approvals", "Shared token required on every approve/reject endpoint"],
            ["Vault-confined file ops", "File actions cannot escape the vault directory"],
