...
class GmailWatcher(BaseWatcher):
    ...
    def __init__(
        self, vault_path: str, client_config: dict, token_data: dict, check_interval: int = 120
    ):
...
class GmailSender:
    ...
    def send_email(
        self, to: str, subject: str, body: str, attachments: List[str] = None, html_body: str = None
    ) -> Dict:
        try:
